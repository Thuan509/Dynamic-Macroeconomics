...
classdef model
    methods(Static)
        ...
        function par = setup()            
            ...
            par.cd = 0.0001; % Cost to use technology 
            ...
            par.delta = 0.3; % Depreciation of health
            ...
            assert(par.delta >= 0.0 && par.delta <= 1.0,'The depreciation of health expenditure received as pension should be from 0 to 1.\n')
        ...
        function par = gen_grids(par)
            ...
            par.hgrid = linspace(par.hmin, par.hmax, par.hlen)';
            ...
            par.hgrid = linspace(par.rmin, par.rmax, par.rlen)';
